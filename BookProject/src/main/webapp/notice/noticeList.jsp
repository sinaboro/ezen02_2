...
%>
	...
	<div id="wrap" align="center">
		...
		<table>
			<tr>
				<c:if test="${member.lev == 'A'}">
					<td colspan="5" style="text-align: right;"><input type="button" value="글쓰기" id="btn" onclick="location.href='BookServlet?command=notice_write_form'"></td>
				</c:if>
			</tr>
			<tr>
			...
			<c:forEach var="notice" items="${notice}">
				<tr>
					...
					<td>${notice.id}</td>
					<td>
						<a href="BookServlet?command=notice_view&num=${notice.num}">
						${notice.title}
						</a>
					</td>
