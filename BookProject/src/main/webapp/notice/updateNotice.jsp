...
%>
	...
	<div id="wrap" align="center">
		...
		<input type="hidden" name="command" value="update_notice">
		<input type="hidden" name="num" value="${notice.num}">
		<table>
				<tr>
					<th>제목</th>
					<td><input type="text" name="title" size="50" value="${notice.title}"></td>
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea cols="110" rows="10" name="content">${notice.content}</textarea></td>
				</tr>
			</table>
			<br><br>
			<input type="submit" value="수정" id="btn" onclick="return updateCheck()">
			<input type="button" value="취소" id="btn" onclick="location.href='BookServlet?command=notice_view&num=${notice.num}'">
