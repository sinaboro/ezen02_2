...
<body>
	<form name="frm">
		...
		<br> 우편번호 : <input type="text" id="zipNo" name="zipNo" size="30" disabled="disabled"><br>
		주&nbsp;&nbsp;소 : <input type="text" id="addr" name="addr" size="80" disabled="disabled">
	</form>
